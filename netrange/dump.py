...
def dumps_ipaddrs(ipaddrs, max_len=None, verbose=False):
    ...
    ranged_ipaddrs = _parser.get_ranged_ipadds(ipaddrs=ipaddrs_tuple, verbose=verbose)
    if max_len is not None:
        separated_ipaddrs = _parser.separate_list(from_list=ranged_ipaddrs, max_len=max_len)
